...
describe('NFTMarketplace', () => {
  ...
  describe('createNFT', () => {
    it('should create an NFT', async () => {
      await nftMarketplace.createNFT('NFT 1', 'Description 1', 'https://example.com/image1.png');
  ...
  describe('buyNFT', () => {
    it('should buy an NFT', async () => {
      await nftMarketplace.createNFT('NFT 1', 'Description 1', 'https://example.com/image1.png');
      await nftMarketplace.connect(addr1).buyNFT(1, { value: ethers.utils.parseEther('0.1') });
      const nft = await nftMarketplace.nfts(1);
